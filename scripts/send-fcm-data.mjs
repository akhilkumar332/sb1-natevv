...
if (!token || !userId) {
  console.error('Usage: node scripts/send-fcm-data.mjs --token=FCM_TOKEN --userId=USER_ID [--userRole=donor] [--type=general] [--title=Test] [--body="..."] [--route=/donor/dashboard?panel=notifications] [--dataOnly=1]');
  process.exit(1);
}
