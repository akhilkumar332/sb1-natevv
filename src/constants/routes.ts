  ...
  portal: {
    ...
    admin: {
      ...
      dashboard: {
        ...
        pwaTelemetry: '/admin/dashboard/pwa-telemetry',
        pwaDiagnostics: '/admin/dashboard/pwa-diagnostics',
        pwaFleetOverview: '/admin/dashboard/pwa-fleet-overview',
        ...
        versionManagement: '/admin/dashboard/version-management',
...
const ADMIN_DASHBOARD_MENU_GROUPS_BASE: AdminDashboardMenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'pwa-telemetry', label: 'PWA Telemetry', path: ROUTES.portal.admin.dashboard.pwaTelemetry },
