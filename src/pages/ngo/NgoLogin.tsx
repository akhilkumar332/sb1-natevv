...
import { Droplet, Heart, Users, Calendar, TrendingUp, Shield } from 'lucide-react';
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4 border-t border-gray-100">
                <div className="text-center">
                  <p className="text-sm text-gray-600 mb-2">Want to register your NGO?</p>
                  <p className="text-sm text-gray-500">
                    Contact our partnership team at{' '}
                    <a href="mailto:ngos@bloodhub.in" className="text-red-600 hover:text-red-700 font-semibold">
                      ngos@bloodhub.in
                    </a>
                  </p>
                </div>
