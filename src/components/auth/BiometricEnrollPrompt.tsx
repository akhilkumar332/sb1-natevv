...
export function BiometricEnrollPrompt({ loading, onEnable, onNotNow, onNever }: Props) {
  return (
    <ModalShell containerClassName="w-full max-w-sm rounded-[24px] bg-white p-6 shadow-2xl relative overflow-hidden">
      ...
      <div className="flex flex-col items-center text-center space-y-4 pt-2">
        ...
        <div className="space-y-1">
          <h3 className="text-lg font-bold text-gray-900">Enable Biometric Login</h3>
          <p className="text-sm text-gray-500">
            Log in faster next time using your fingerprint or Face ID — no OTP needed.
          </p>
        </div>
